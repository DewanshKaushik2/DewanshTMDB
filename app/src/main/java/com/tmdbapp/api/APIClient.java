...
public class APIClient {
    ...
    public static MovieAPI getClient(String URL) {
        ...
        Gson gson = new GsonBuilder()
                .registerTypeAdapter(new TypeToken<ArrayList<MovieModel>>() {
                }.getType(), new MovieJsonDeserializer())
                .registerTypeAdapter(new TypeToken<ArrayList<VideoModel>>() {
                }.getType(), new VideoJsonDeserializer())
                .registerTypeAdapter(new TypeToken<Credits>() {
                }.getType(), new CreditsJsonDeserializer())
                .create();
