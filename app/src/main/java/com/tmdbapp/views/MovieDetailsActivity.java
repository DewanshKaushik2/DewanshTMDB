...
//    private YouTubePlayerView youTubePlayerView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.myDetailsViewModel = new ViewModelProvider(this, viewModelFactory).get(MyDetailsViewModel.class);
...
//        this.youTubePlayerView = findViewById(R.id.video_trailer);
        ...
        this.bookmarkFavorite.setOnClickListener(view -> this.myDetailsViewModel
                .updateMovieFavorite(this.movie.getId(), !this.movie.isFavorite()));
        this.backButton.setOnClickListener(view -> finishAfterTransition());

        this.myDetailsViewModel.setMovie(id).observe(this, this::loadMovie);
        this.myDetailsViewModel.getFavoriteMessage().observe(this, this::displayFavoriteToast);
    }
